...
impl LockTime {
    ...
    /// * `block_produced_height`: The height of the previous block (i.e. chain tip block height).
    ///
    /// # Errors
    ///
    ...
    /// * `block_produced_time`: The MTP of the previous block (defined in quote above).
    ///
